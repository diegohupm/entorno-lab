  ...
  <body class="u-body u-xl-mode"><header class="u-clearfix u-header u-header" id="sec-422f"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-image u-shading u-section-1" id="sec-976e" data-image-width="1600" data-image-height="560">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <div class="u-form u-login-control u-form-1">
          <form action="<%=request.getContextPath()%>/login" method="POST" class="u-clearfix u-form-custom-backend u-form-spacing-38 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 30px;">
            ...
            <div class="u-form-group u-form-password">
              ...
              <input type="password" placeholder="Ingresa tu contraseña" id="contrasena" name="contrasena" class="u-border-2 u-border-white u-input u-input-rectangle u-input-2" required="" maxlength="80">
            </div>
        ...
        <!--<a href="https://nicepage.com/k/birthday-html-templates" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-forgot-password u-none u-text-body-alt-color u-text-hover-palette-3-base u-btn-2">¿Quieres recuperar tu contraseña?</a>
        <a href="https://nicepage.one" class="u-border-active-palette-2-base u-border-hover-palette-1-base u-border-none u-btn u-button-style u-login-control u-login-create-account u-none u-text-hover-white u-text-palette-3-base u-btn-3">Si no tienes cuenta, registrate aquí</a>-->
      </div>
    </section>
